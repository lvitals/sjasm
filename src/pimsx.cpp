...
void initPiMSX() {
  FunctionEntry<mFun> msxfuns[] = {
    const_cast<char *>("adc"),pmADC,
    const_cast<char *>("add"),pmADD,
    const_cast<char *>("and"),pmAND,
    const_cast<char *>("bit"),pmBIT,
    const_cast<char *>("call"),pmCALL,
    const_cast<char *>("ccf"),pmCCF,
    const_cast<char *>("cp"),pmCP,
    const_cast<char *>("cpd"),pmCPD,
    const_cast<char *>("cpdr"),pmCPDR,
    const_cast<char *>("cpi"),pmCPI,
    const_cast<char *>("cpir"),pmCPIR,
    const_cast<char *>("cpl"),pmCPL,
    const_cast<char *>("daa"),pmDAA,
    const_cast<char *>("dec"),pmDEC,
    const_cast<char *>("di"),pmDI,
    const_cast<char *>("djnz"),pmDJNZ,
    const_cast<char *>("ei"),pmEI,
    const_cast<char *>("ex"),pmEX,
    const_cast<char *>("exx"),pmEXX,
    const_cast<char *>("halt"),pmHALT,
    const_cast<char *>("im"),pmIM,
    const_cast<char *>("in"),pmIN,
    const_cast<char *>("inc"),pmINC,
    const_cast<char *>("ind"),pmIND,
    const_cast<char *>("indr"),pmINDR,
    const_cast<char *>("ini"),pmINI,
    const_cast<char *>("inir"),pmINIR,
    const_cast<char *>("jp"),pmJP,
    const_cast<char *>("jr"),pmJR,
    const_cast<char *>("ld"),pmLD,
    const_cast<char *>("ldd"),pmLDD,
    const_cast<char *>("lddr"),pmLDDR,
    const_cast<char *>("ldi"),pmLDI,
    const_cast<char *>("ldir"),pmLDIR,
    const_cast<char *>("mulub"),pmMULUB,
    const_cast<char *>("muluw"),pmMULUW,
    const_cast<char *>("neg"),pmNEG,
    const_cast<char *>("nop"),pmNOP,
    const_cast<char *>("or"),pmOR,
    const_cast<char *>("otdr"),pmOTDR,
    const_cast<char *>("otir"),pmOTIR,
    const_cast<char *>("out"),pmOUT,
    const_cast<char *>("outd"),pmOUTD,
    const_cast<char *>("outi"),pmOUTI,
    const_cast<char *>("pop"),pmPOP,
    const_cast<char *>("push"),pmPUSH,
    const_cast<char *>("res"),pmRES,
    const_cast<char *>("ret"),pmRET,
    const_cast<char *>("reti"),pmRETI,
    const_cast<char *>("retn"),pmRETN,
    const_cast<char *>("rl"),pmRL,
    const_cast<char *>("rla"),pmRLA,
    const_cast<char *>("rlc"),pmRLC,
    const_cast<char *>("rlca"),pmRLCA,
    const_cast<char *>("rld"),pmRLD,
    const_cast<char *>("rr"),pmRR,
    const_cast<char *>("rra"),pmRRA,
    const_cast<char *>("rrc"),pmRRC,
    const_cast<char *>("rrca"),pmRRCA,
    const_cast<char *>("rrd"),pmRRD,
    const_cast<char *>("rst"),pmRST,
    const_cast<char *>("sbc"),pmSBC,
    const_cast<char *>("scf"),pmSCF,
    const_cast<char *>("set"),pmSET,
    const_cast<char *>("sla"),pmSLA,
    const_cast<char *>("sll"),pmSLL,
    const_cast<char *>("sra"),pmSRA,
    const_cast<char *>("srl"),pmSRL,
    const_cast<char *>("sub"),pmSUB,
    const_cast<char *>("xor"),pmXOR,
